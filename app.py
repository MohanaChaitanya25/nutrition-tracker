...
# # --- CONFIGURATION ---
# SHEET_NAME = "ProNutritionDB" # The name of your Google Sheet file
# WORKSHEET_LOGS = "Logs"       # Name of the first tab
# WORKSHEET_TARGETS = "Targets" # Name of the second tab
...
# # --- CSS STYLING (Kept exactly as your original) ---
# st.markdown("""
#     <style>
#     .block-container { padding-top: 1rem; padding-bottom: 5rem; }
    
#     /* MOBILE-FIRST METRICS - HORIZONTAL SCROLL */
#     .metrics-container {
#         display: flex;
#         gap: 12px;
#         overflow-x: auto;
...
if not st.session_state.onboarding_complete:
    st.markdown("---")
    st.subheader("👋 Welcome! Let's set your goals.")
    st.write("We need a baseline to track your progress. You can change this later.")
